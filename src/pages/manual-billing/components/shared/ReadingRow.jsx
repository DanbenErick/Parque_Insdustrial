...
export const ReadingRow = React.memo(({ record, medidorInfo, onEdit = null, showDateFull = false, onClick = null }) => (
  ...
  >
    <div className="md:col-span-4 flex flex-col gap-0.5 overflow-hidden">
    ...
    <div className="md:col-span-6 flex flex-row flex-wrap items-center gap-x-6 gap-y-2 pt-2 md:pt-0 border-t md:border-t-0 border-outline-variant/50">
